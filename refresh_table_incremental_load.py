...
tables = {
    ...
    "account":
    """
    select Id, SystemModstamp, IsDeleted, LastModifiedById, ParentId, Parent_Account__c, Name, CreatedDate, Region__c, ShippingCountry, Buy_Sell_Side__c, Buy_Side_Type__c, Customer_Type__c, CreatedById, OwnerId, Pure_Commods_Account__c
    from account
